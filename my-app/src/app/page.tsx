        ...
        <div className="flex flex-col gap-1">
          ...
          {externalSites.map((site) => (
            <Link
              ...
              href={site.url}
              target="_blank"
              className="flex items-center justify-between p-3 bg-zinc-100 dark:bg-zinc-800 rounded-lg hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-zinc-700 transition-colors border-l-4 border-transparent hover:border-blue-500"
            >
              {site.name}
